...
randABI = '''[
		...
		"outputs": [
			{
				...
				"internalType": "struct MasterCats.ClaimBalances",
				"name": "balances",
				"type": "tuple"
			}
		],
		...
		"inputs": [
			{
				"components": [
					...
					{
						"internalType": "bool",
						"name": "isFreeMintActive",
						"type": "bool"
					}
				],
				"internalType": "struct MasterCats.MintConfig",
				"name": "config",
				"type": "tuple"
			}
		],
	...
	},
	{
		"inputs": [
			{
				"internalType": "contract IThe3030Badge",
				"name": "newPrincipal",
				"type": "address"
			}
		],
	...
	},
	{
		"inputs": [
			...
			},
			{
				...
				"internalType": "struct ChildContractExploit.NFTs[]",
				"name": "NFTsInContract",
				"type": "tuple[]"
			}
		],
